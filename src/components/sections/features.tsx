        ...
        >
          {features.map((f, i) => (
            <motion.li
              ...
              className="group relative overflow-hidden rounded-2xl border border-border bg-card p-5 shadow-premium transition-all duration-300 hover:-translate-y-1 hover:border-wa-green/40 hover:shadow-glow-wa"
            >
              {/* hover glow */}
              <div
                aria-hidden
